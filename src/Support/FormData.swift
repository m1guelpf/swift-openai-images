...
final class FormData {
	...
	convenience init(boundary: String = UUID().uuidString, from entries: any FormDataEncodable) throws {
		try self.init(boundary: boundary, entries: entries.encode())
	}
